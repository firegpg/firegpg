...
FireGPGMime = {
    ...
    extractSignedData: function(message) {
        ...
        if (hash == '') {
            fireGPGDebug('hash faillure', 'FireGPGMime.extractSignedData',true);
            return '';
        }
        ...
        if (blockId == '') {
            fireGPGDebug('block faillure', 'FireGPGMime.extractSignedData',true);
            return '';
        }
        ...
        if (signature == '') {
            fireGPGDebug('find signature faillure', 'FireGPGMime.extractSignedData',true);
            return '';
        }
    ...
    extractEncryptedData: function(message) {
        ...
        if (data == '') {
            fireGPGDebug('find encryped part faillure', 'FireGPGMime.extractSignedData',true);
            return '';
        }
