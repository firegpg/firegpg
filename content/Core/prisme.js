...
strings = document.createElement('stringbundle');
strings.setAttribute('id', 'firegpg-strings');
strings.setAttribute('src', 'chrome://firegpg/locale/firegpg.properties');
document.getElementById('webrunner').appendChild(strings);
