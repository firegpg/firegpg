...
class NS_NO_VTABLE IFireGPGCall : public nsISupports {
 public: 
  ...
  NS_IMETHOD Call(const char *path, const char *parameters, const char *sdin, char **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_IFIREGPGCALL \
  NS_IMETHOD Call(const char *path, const char *parameters, const char *sdin, char **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_IFIREGPGCALL(_to) \
  NS_IMETHOD Call(const char *path, const char *parameters, const char *sdin, char **_retval) { return _to Call(path, parameters, sdin, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_IFIREGPGCALL(_to) \
  NS_IMETHOD Call(const char *path, const char *parameters, const char *sdin, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Call(path, parameters, sdin, _retval); } 
...
/* string Call (in string path, in string parameters, in string sdin); */
NS_IMETHODIMP _MYCLASS_::Call(const char *path, const char *parameters, const char *sdin, char **_retval)
{
